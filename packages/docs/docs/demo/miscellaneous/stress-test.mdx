...
import DEMO_REACT from '!!raw-loader!@site/src/examples/stress-test/set-state/react-built-in.tsx'
import DEMO_COTTON_BOX from '!!raw-loader!@site/src/examples/stress-test/set-state/cotton-box.tsx'
import DEMO_ZUSTAND from '!!raw-loader!@site/src/examples/stress-test/set-state/zustand.tsx'
import DEMO_REDUX from '!!raw-loader!@site/src/examples/stress-test/set-state/redux.tsx'

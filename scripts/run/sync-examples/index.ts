...
const pathToCrawl = './src/pages/examples'
const destinationFrontPath = './src/packages/docs/src/examples'
...
// console.log('pathSpecs', JSON.stringify(pathSpecs, null, 2))
...
for (const [pathSegments, fileName] of pathSpecs) {
  ...
  deepSet(
    obj,
    /^index/.test(fileName) ? pathSegments : [...pathSegments, fileName],
    0
  )
}
...
writeFileSync(
  './src/~constants/page-index.scripted.ts',
  [

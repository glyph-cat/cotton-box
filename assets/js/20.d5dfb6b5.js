...
/* harmony export */ });
/* harmony import */ var dequal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8460);
...
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/dist/types-0877c553.mjs
var types_0877c553 = __webpack_require__(3128);
...
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/dist/base-80a1f760.mjs
var base_80a1f760 = __webpack_require__(5399);
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/dist/consoleHook-cdbe54ab.mjs
var consoleHook_cdbe54ab = __webpack_require__(6253);
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/node_modules/outvariant/lib/index.mjs
var lib = __webpack_require__(1562);
// EXTERNAL MODULE: ./node_modules/dequal/dist/index.mjs
var dist = __webpack_require__(8460);
...
function loadPreviewIframe(iframe, url) {
    return (0,types_0877c553._)(this, void 0, void 0, function () {
        var contentWindow, TIME_OUT, MAX_MANY_TIRES, tries, timeout;
        return (0,types_0877c553.a)(this, function (_a) {
            contentWindow = iframe.contentWindow;
            (0,types_0877c553.n)(contentWindow, "Failed to await preview iframe: no content window found");
            TIME_OUT = 90000;
            MAX_MANY_TIRES = 20;
            tries = 0;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var triesToSetUrl = function () {
                        ...
                        if (tries >= MAX_MANY_TIRES) {
                            reject((0,types_0877c553.c)("Could not able to connect to preview."));
                            return;
                        }
...
var scripts = [
    ...
    {
        code: "function consoleHook({ scope }) {" + consoleHook_cdbe54ab.c + "\n};",
        id: "consoleHook",
    },
...
var SandpackNode = /** @class */ (function (_super) {
    (0,types_0877c553.g)(SandpackNode, _super);
    function SandpackNode(selector, sandboxInfo, options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this, selector, sandboxInfo, (0,types_0877c553.h)((0,types_0877c553.h)({}, options), { bundlerURL: options.bundlerURL })) || this;
        _this._modulesCache = new Map();
        _this.messageChannelId = (0,consoleHook_cdbe54ab.g)();
        _this._initPromise = null;
        _this.emitter = new consoleHook_cdbe54ab.E();
        // Assign iframes
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        this.dispatch({
                            ...
                            title: (0,consoleHook_cdbe54ab.a)(err_1),
                        });
    ...
    SandpackNode.prototype.createShellProcessFromTask = function (files) {
        return (0,types_0877c553._)(this, void 0, void 0, function () {
            ...
            var _a;
            var _this = this;
            return (0,types_0877c553.a)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packageJsonContent = (0,consoleHook_cdbe54ab.r)(files["/package.json"]);
                        this.emulatorCommand = (0,consoleHook_cdbe54ab.b)(packageJsonContent);
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("exit", function (exitCode) {
                                _this.dispatch({
                                    ...
                                    action: "notification",
                                    notificationType: "error",
                                    title: (0,types_0877c553.c)("Error: process.exit(".concat(exitCode, ") called.")),
                                });
                            })];
                    case 1:
                        // Shell listeners
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("progress", function (data) {
                                ...
                                if (data.state === "command_running" ||
                                    ...
                                    _this.dispatch({
                                        type: "shell/progress",
                                        data: (0,types_0877c553.h)((0,types_0877c553.h)({}, data), { command: [
    ...
    SandpackNode.prototype.manageIframes = function (selector) {
        ...
        if (typeof selector === "string") {
            ...
            (0,types_0877c553.n)(element, "The element '".concat(selector, "' was not found"));
        ...
        (0,types_0877c553.n)(this.iframe.parentNode, "The given iframe does not have a parent.");
        /**
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.emulator.fs.watch(["*"], [
                                ...
                                ".config",
                                ".vuepress",
                            ], function (message) { return (0,types_0877c553._)(_this, void 0, void 0, function () {
                                ...
                                return (0,types_0877c553.a)(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            this._modulesCache.set(event.path, (0,consoleHook_cdbe54ab.w)(content));
                                            return [3 /*break*/, 9];
                                        case 5:
                                            this.dispatch({
                                                type: "fs/remove",
                                        ...
                                        case 7:
                                            ...
                                            this._modulesCache.set(event.newPath, (0,consoleHook_cdbe54ab.w)(newContent));
                                            return [3 /*break*/, 9];
                                        ...
                                        case 10:
                                            ...
                                            this.dispatch({
                                                ...
                                                action: "notification",
                                                notificationType: "error",
                                                title: (0,consoleHook_cdbe54ab.a)(err_2),
                                            });
                                            return [3 /*break*/, 11];
    ...
    SandpackNode.prototype.updateSandbox = function (setup) {
        var _this = this;
        var _a;
        var modules = (0,consoleHook_cdbe54ab.f)(setup.files);
        /**
         * Update file changes
         */
        if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function (_a) {
                ...
                if (!_this._modulesCache.get(key) ||
                    (0,consoleHook_cdbe54ab.r)(value) !== (0,consoleHook_cdbe54ab.r)(_this._modulesCache.get(key))) {
        ...
        Object.entries(modules).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            _this._modulesCache.set(key, (0,consoleHook_cdbe54ab.w)(value));
        });
    };
    SandpackNode.prototype.dispatch = function (message) {
        ...
        return (0,types_0877c553._)(this, void 0, void 0, function () {
            var _c;
            return (0,types_0877c553.a)(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = message.type;
                        switch (_c) {
...
/* harmony export */ });
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1562);
/* harmony import */ var _types_0877c553_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3128);
...
var findStartScriptPackageJson = function (packageJson) {
    ...
    (0,outvariant__WEBPACK_IMPORTED_MODULE_0__/* .invariant */ .V1)(scripts, "Failed to start. Please provide a `start` or `dev` script on the package.json");

...
export const DocConstants = {
  ...
  // #region tsdoc
  TSDOC_WARN_NOT_COMPATIBLE_HERE_STATE_MANAGER: `## ❌ [\`StateManager\`](${DOCS_API_CORE_URL}/StateManager) is not compatible here.`,
  TSDOC_WARN_NOT_COMPATIBLE_HERE_ASYNC_STATE_MANAGER: `## ❌ [\`AsyncStateManager\`](${DOCS_API_CORE_URL}/AsyncStateManager) is not compatible here.`,
  ...
  TSDOC_DESC_SIMPLE_FINITE_STATE_MANAGER: 'A bare-bones state manager that only allows state change according to a set of predefined state transitions.',
  ...
  TSDOC_DESC_OPTIONS_SERIALIZE_STATE: 'A function to serialize the state. Only used for debugging.',
  TSDOC_DESC_OPTIONS_SIMPLE: `Additional options for [\`SimpleStateManager\`](${DOCS_API_CORE_URL}/SimpleStateManager).`,
  TSDOC_DESC_OPTIONS_SIMPLE_FINITE: `Additional options for [\`SimpleFiniteStateManager\`](${DOCS_API_CORE_URL}/SimpleFiniteStateManager).`,
  ...
  TSDOC_DESC_USE_SIMPLE_STATE_VALUE: `A React hook to consume a [\`SimpleStateManager\`](${DOCS_API_CORE_URL}/SimpleStateManager) or [\`SimpleFiniteStateManager\`](${DOCS_API_CORE_URL}/SimpleFiniteStateManager).`,
  TSDOC_DESC_USE_SIMPLE_STATE_VALUE_ONLY: `A minimal React hook to consume a [\`SimpleStateManager\`](${DOCS_API_CORE_URL}/SimpleStateManager) or [\`SimpleFiniteStateManager\`](${DOCS_API_CORE_URL}/SimpleFiniteStateManager) that doesn't support additional options or selectors.`,
  TSDOC_DESC_USE_STATE_VALUE: `A React hook to consume either a [\`SimpleStateManager\`](${DOCS_API_CORE_URL}/SimpleStateManager), [\`StateManager\`](${DOCS_API_CORE_URL}/StateManager), [\`AsyncStateManager\`](${DOCS_API_CORE_URL}/AsyncStateManager), or [\`SimpleFiniteStateManager\`](${DOCS_API_CORE_URL}/SimpleFiniteStateManager).`,
